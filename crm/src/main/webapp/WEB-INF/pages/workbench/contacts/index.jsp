...
<script type="text/javascript">
	...
	$(function(){
		...
		$("#create-customerName").typeahead({
			success:function (query, process) {
				$.get(
						"",
						{"customerName":query},
						function (data) {
	...
	/*----------------------------------------------------------------------------------------------------*/
	//分页函数
	function contactsPageList(pageNo,pageSize) {
		//收集参数
				...
				<div class="modal-body">
					<form class="form-horizontal" role="form">
						...
						<div class="form-group" style="position: relative;">
							...
							<div class="col-sm-10" style="width: 300px;">
								<input type="text" class="form-control time" id="create-birthday" readonly>
							</div>
						</div>
						
						<div class="form-group" style="position: relative;">
							<label for="create-custumerName" class="col-sm-2 control-label">客户名称</label>
							<div class="col-sm-10" style="width: 300px;">
								<input type="text" class="form-control" id="create-custumerName" placeholder="支持自动补全，输入客户不存在则新建">
							</div>
						</div>
