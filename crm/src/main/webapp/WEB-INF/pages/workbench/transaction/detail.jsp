...
<script type="text/javascript">
	...
	$(function(){
		...
		$("#saveRemarkBtn").click(function () {
			...
			$.ajax({
				url:"workbench.transaction/saveTranRemark.do",
				data:{
...
<body>
	...
	<div style="position: relative; left: 40px; top: -50px;">
		...
		<c:forEach items="${stageList}" var="s">
			<!--如果stage就是交易所处阶段，则显示图标为map-marker，颜色绿色-->
			...
			<!--如果stage处在当前交易前边，则显示图标为ok-circle，颜色绿色-->
			...
			<!--如果stage处在当前交易后边，则显示图标为record mystage，颜色黑色-->
			<c:if test="${tran.orderNo<s.orderNo}">
	...
	<div style="position: relative; top: 100px; left: 40px;">
		...
		<c:forEach items="${tranRemarkList}" var="r">
